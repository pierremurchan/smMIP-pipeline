...
if (is.null(opt$output)){ 
  print(paste0("Outputting to the same folder as the bam file: ",dirname(opt$bam.file)),quote = F)
...
cat("\n")
cat("Writing file to:", paste0(opt$output,"/",opt$sample.name,"_raw_pileup.txt"))
